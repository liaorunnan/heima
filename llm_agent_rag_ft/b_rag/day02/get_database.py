...
class Wenda(SQLModel, table=True):
...
def conmunication():
    ...
    with sync_playwright() as p:
        ...
        url = "https://zhuanlan.zhihu.com/p/700254409"
        ...
        try:
            ...
            if not sentences:
                sentences = page.locator("div[class*='RichText-ADLinkCardContainer'] p").all()
            ...
            for i, sentence_locator in enumerate(sentences):
                try:
                    ...
                    text = re.sub(r'^[^.]*\.', '', text)
                    wenda = Wenda(wenda=text)
                    wenda.insert()  # 调用你的 insert 方法
