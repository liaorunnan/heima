...
# 外部 URL（不带端口！）
external_url 'http://8.134.221.210'
#
# Nginx 监听 8080 端口（对外提供服务）
nginx['listen_port'] = 8080
nginx['listen_https'] = false
#
# 【关键】强制 Puma 只使用 Unix Socket，禁用 TCP
puma['port'] = nil
puma['listen'] = 'unix:///var/opt/gitlab/gitlab-rails/sockets/gitlab.socket'
puma['tcp_listen'] = false
puma['bind'] = []   # ← 清空自动绑定列表，防止生成非法地址
#
# 禁用 KAS
gitlab_kas['enable'] = false
# 告诉 Rails 用户实际访问的是 8080 端口（用于生成链接）
gitlab_rails['gitlab_host'] = '8.134.221.210'
