from tools.chat_llm import chat

from playwright.sync_api import sync_playwright
from agent_bash.prompt_bash import *
from conf import settings
from tqdm import tqdm
from datetime import datetime, timedelta
# 使用相对导入访问上级目录中的email模块
from email_function.sendemail import send_email  
...
if __name__ == '__main__':
    ...
    with sync_playwright() as p:
        ...
        for since in since_params:
            ...
            for i, in_box in tqdm(enumerate(Box_div[:10]), desc=f"处理{since_text}"):  # 处理前10个仓库
